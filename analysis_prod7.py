...
same_ts = 0
same_ts_indices = []
imag_freq_threshold, deltaG_threshold = 10, 0.0285
diff_imag_freq_nums, diff_deltaG_f_nums, diff_deltaG_r_nums = 0, 0, 0
...
print('diff_imag_freq_nums', diff_imag_freq_nums)
